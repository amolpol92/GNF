...
public class PulledMessage {
	...
	public PulledMessage(String messageId, String message, String publishTime, String ackId, String globalTxnId) {
		super();
	...
	public String toString() {
		return "PulledMessage [id=" + id + ", messageId=" + messageId + ", message=" + message + ", subscriptionId="
				+ subscriptionId + ", publishTime=" + publishTime + ", pullTime=" + pullTime + ", globalTransactionId="
				+ globalTransactionId + ", ackId=" + ackId + ", destGroupId=" + destGroupId + "]";
	}
