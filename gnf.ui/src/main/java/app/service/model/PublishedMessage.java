...
public class PublishedMessage {
	 ...
	 * @param globalTxnId
	 */
	public PublishedMessage(String message, String topicName, String messageId, String publishTime) {
		this(message, topicName, messageId);
		this.publishTime = publishTime;
	}

	public PublishedMessage(String message, String topicName, String messageId) {
		this(message, topicName);
		this.messageId = messageId;
	}

	public PublishedMessage(String message, String topicName) {
