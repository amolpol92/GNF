...
public String toString() {
	return "DeliveryStatus [email=" + email + ", timestamp=" + timestamp + ", smtpId=" + smtpId + ", event=" + event
			+ ", category=" + category + ", sg_event_id=" + sg_event_id + ", sg_message_id=" + sg_message_id
			+ ", response=" + response + ", attempt=" + attempt + ", useragent=" + useragent + ", ip=" + ip + ", url="
			+ url + ", reason=" + reason + ", status=" + status + ", asm_group_id=" + asm_group_id + "]";
}
