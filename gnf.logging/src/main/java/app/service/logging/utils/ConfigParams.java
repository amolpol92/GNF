...
public class ConfigParams {
	...
	public static class ParamsBuilder {
		...
		public String toString() {
			return "ParamsBuilder [instanceConnectionName=" + instanceConnectionName + ", connectionString="
					+ connectionString + ", jdbcConnectionUrl=" + jdbcConnectionUrl + ", dbName=" + dbName + ", conn="
					+ conn + ", userName=" + userName + ", passwd=" + passwd + ", tableName=" + tableName
					+ ", topicName=" + topicName + ", subscriberName=" + subscriberName + "]";
		}
